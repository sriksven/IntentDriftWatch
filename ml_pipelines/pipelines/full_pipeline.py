...
LOG_DIR = os.path.join(ROOT_DIR, "ml_pipelines", "monitoring", "logs")
...
def run_full_pipeline():
    ...
    # MLflow setup
    # -----------------------------
    mlflow.set_tracking_uri("file:./ml_pipelines/mlruns")
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        semantic_reports = glob("reports/generated/semantic/*.json")
        ...
        if os.path.exists("reports/generated/semantic"):
            mlflow.log_artifacts("reports/generated/semantic", artifact_path="semantic_reports")
        ...
        if run_concept_drift is not None:
            ...
            concept_reports = glob("reports/generated/concept/*.json")
            ...
            if os.path.exists("reports/generated/concept"):
                mlflow.log_artifacts("reports/generated/concept", artifact_path="concept_reports")
        else:
        ...
        # -----------------------------
        if os.path.exists("reports/generated/visual"):
            mlflow.log_artifacts("reports/generated/visual", artifact_path="visual_reports")
